...
<main class="container-fluid text-center">
  <div class="p-4 p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-12 px-0">
      <img class="rounded-5" src="<?php the_post_thumbnail_url(); ?>" style="width:100%; max-width:900px; max-height:400px" />
  ...
  <div class="row g-5">
    <div class="col-md-8">
      <div class="pb-4 mb-4 fst-italic border-bottom">
        ...
        <p class="text-muted text-black">Posted on: <?php the_time('d M Y'); ?></p> <!-- the time format from wordpress codex -->
      ...
      <div class="position-sticky" style="top: 2rem;">
        ...
        <div class="p-4">
          ...
          <ol class="list-unstyled">
            <li><a href="<?php the_permalink(); ?>"><?php wp_list_categories(); ?></a></li>
          </ol>
        </div>
      </div>
    </div>
